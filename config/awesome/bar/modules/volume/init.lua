...
local widget = wibox.widget({
  {
    ...
    {
      id = "icon",
      markup = helper.color_text_icon("  ", pallete.brightblue, beautiful.font_size),
...
awesome.connect_signal("volume::update", function(volume, icon)
  widget.iconbg.icon:set_markup(helper.color_text_icon(icon, pallete.brightblue, beautiful.font_size))
