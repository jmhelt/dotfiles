...
theme.font_alt = settings.font_alt
theme.icon_font = settings.icon_font
...
theme.taglist_font = theme.icon_font .. " " .. theme.font_size
...
theme.menu_font = theme.font_alt .. " " .. theme.font_size
